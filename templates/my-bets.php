...
<section class="rates container">
    ...
    <table class="rates__list">
        <tr class="rates__item">
            <td class="rates__info">
                <div class="rates__img">
                    <img src="/assets/img/rate1.jpg" width="54" height="40" alt="Сноуборд">
                </div>
        ...
        <tr class="rates__item">
            <td class="rates__info">
                <div class="rates__img">
                    <img src="/assets/img/rate2.jpg" width="54" height="40" alt="Сноуборд">
                </div>
        ...
        <tr class="rates__item rates__item--win">
            <td class="rates__info">
                <div class="rates__img">
                    <img src="/assets/img/rate3.jpg" width="54" height="40" alt="Крепления">
                </div>
                <div>
        ...
        <tr class="rates__item">
            <td class="rates__info">
                <div class="rates__img">
                    <img src="/assets/img/rate4.jpg" width="54" height="40" alt="Ботинки">
                </div>
        ...
        <tr class="rates__item rates__item--end">
            <td class="rates__info">
                <div class="rates__img">
                    <img src="/assets/img/rate5.jpg" width="54" height="40" alt="Куртка">
                </div>
        ...
        <tr class="rates__item rates__item--end">
            <td class="rates__info">
                <div class="rates__img">
                    <img src="/assets/img/rate6.jpg" width="54" height="40" alt="Маска">
                </div>
        ...
        <tr class="rates__item rates__item--end">
            <td class="rates__info">
                <div class="rates__img">
                    <img src="/assets/img/rate7.jpg" width="54" height="40" alt="Сноуборд">
                </div>
                <h3 class="rates__title"><a href="lot.html">DC Ply Mens 2016/2017 Snowboard</a></h3>
            </td>
            <td class="rates__category">
